...
const Chat = () => {
  ...
  return (
    ...
    >
      <Card
        className="w-full max-w-4xl h-[80vh] shadow-2xl rounded-2xl flex flex-col"
        style={{
      ...
      >
        <CardContent className="p-6 flex flex-col h-full">
          ...
          {/* Messages Section */}
          <div
            className="flex-grow overflow-y-auto mb-6 space-y-6 p-4 sm:p-6"
            style={{
          ...
          >
            {messages.map((msg, index) => (
              ...
              >
                <div
                  className={`max-w-[80%] px-6 py-4 rounded-3xl shadow-md ${
                    msg.sender === "user"
          ...
          <div className="flex space-x-2 mt-auto">
            <Input
              ...
              className="flex-grow px-6 py-4 rounded-xl text-base"
              style={{
